                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex justify-between items-center">
                                    <a href="add_to_wishlist.php?id=<?php echo $id; ?>" class="text-pink-600 hover:text-pink-700"><i class="bi bi-heart-fill"></i> Wishlist</a>
<a href="add_to_cart.php?id=<?php echo $id; ?>" class="text-pink-600 hover:text-pink-700"><i class="bi bi-cart-fill"></i> Add to Cart</a>
